...
(defun vgg16fcn (&optional weights)
  (let* ((weights (or weights (read-vgg16-weights t)))
         (w14 (getf weights :w14))
         (b14 (getf weights :b14))
         (w15 (getf weights :w15))
         (b15 (getf weights :b15))
         (w16 (getf weights :w16))
         (b16 (getf weights :b16))
         (k14 ($reshape ($transpose w14) 4096 512 7 7))
         (b14 ($squeeze b14))
         (k15 ($reshape ($transpose w15) 4096 4096 1 1))
         (b15 ($squeeze b15))
