...
(defun lstm2-write-weights ()
  (lstm2-write-weight-to *wa1* "examples/gench-lstm2-weights/gench-lstm2-wa1.dat")
  (lstm2-write-weight-to *ua1* "examples/gench-lstm2-weights/gench-lstm2-ua1.dat")
  (lstm2-write-weight-to *ba1* "examples/gench-lstm2-weights/gench-lstm2-ba1.dat")
  (lstm2-write-weight-to *wi1* "examples/gench-lstm2-weights/gench-lstm2-wi1.dat")
  (lstm2-write-weight-to *ui1* "examples/gench-lstm2-weights/gench-lstm2-ui1.dat")
  (lstm2-write-weight-to *bi1* "examples/gench-lstm2-weights/gench-lstm2-bi1.dat")
  (lstm2-write-weight-to *wf1* "examples/gench-lstm2-weights/gench-lstm2-wf1.dat")
  (lstm2-write-weight-to *uf1* "examples/gench-lstm2-weights/gench-lstm2-uf1.dat")
  (lstm2-write-weight-to *bf1* "examples/gench-lstm2-weights/gench-lstm2-bf1.dat")
  (lstm2-write-weight-to *wo1* "examples/gench-lstm2-weights/gench-lstm2-wo1.dat")
  (lstm2-write-weight-to *uo1* "examples/gench-lstm2-weights/gench-lstm2-uo1.dat")
  (lstm2-write-weight-to *bo1* "examples/gench-lstm2-weights/gench-lstm2-bo1.dat")

  (lstm2-write-weight-to *wa2* "examples/gench-lstm2-weights/gench-lstm2-wa2.dat")
  (lstm2-write-weight-to *ua2* "examples/gench-lstm2-weights/gench-lstm2-ua2.dat")
  (lstm2-write-weight-to *ba2* "examples/gench-lstm2-weights/gench-lstm2-ba2.dat")
  (lstm2-write-weight-to *wi2* "examples/gench-lstm2-weights/gench-lstm2-wi2.dat")
  (lstm2-write-weight-to *ui2* "examples/gench-lstm2-weights/gench-lstm2-ui2.dat")
  (lstm2-write-weight-to *bi2* "examples/gench-lstm2-weights/gench-lstm2-bi2.dat")
  (lstm2-write-weight-to *wf2* "examples/gench-lstm2-weights/gench-lstm2-wf2.dat")
  (lstm2-write-weight-to *uf2* "examples/gench-lstm2-weights/gench-lstm2-uf2.dat")
  (lstm2-write-weight-to *bf2* "examples/gench-lstm2-weights/gench-lstm2-bf2.dat")
  (lstm2-write-weight-to *wo2* "examples/gench-lstm2-weights/gench-lstm2-wo2.dat")
  (lstm2-write-weight-to *uo2* "examples/gench-lstm2-weights/gench-lstm2-uo2.dat")
  (lstm2-write-weight-to *bo2* "examples/gench-lstm2-weights/gench-lstm2-bo2.dat")

  (lstm2-write-weight-to *wy* "examples/gench-lstm2-weights/gench-lstm2-wy.dat")
  (lstm2-write-weight-to *by* "examples/gench-lstm2-weights/gench-lstm2-by.dat"))
...
(defun lstm2-read-weights ()
  (lstm2-read-weight-from *wa1* "examples/gench-lstm2-weights/gench-lstm2-wa1.dat")
  (lstm2-read-weight-from *ua1* "examples/gench-lstm2-weights/gench-lstm2-ua1.dat")
  (lstm2-read-weight-from *ba1* "examples/gench-lstm2-weights/gench-lstm2-ba1.dat")
  (lstm2-read-weight-from *wi1* "examples/gench-lstm2-weights/gench-lstm2-wi1.dat")
  (lstm2-read-weight-from *ui1* "examples/gench-lstm2-weights/gench-lstm2-ui1.dat")
  (lstm2-read-weight-from *bi1* "examples/gench-lstm2-weights/gench-lstm2-bi1.dat")
  (lstm2-read-weight-from *wf1* "examples/gench-lstm2-weights/gench-lstm2-wf1.dat")
  (lstm2-read-weight-from *uf1* "examples/gench-lstm2-weights/gench-lstm2-uf1.dat")
  (lstm2-read-weight-from *bf1* "examples/gench-lstm2-weights/gench-lstm2-bf1.dat")
  (lstm2-read-weight-from *wo1* "examples/gench-lstm2-weights/gench-lstm2-wo1.dat")
  (lstm2-read-weight-from *uo1* "examples/gench-lstm2-weights/gench-lstm2-uo1.dat")
  (lstm2-read-weight-from *bo1* "examples/gench-lstm2-weights/gench-lstm2-bo1.dat")

  (lstm2-read-weight-from *wa2* "examples/gench-lstm2-weights/gench-lstm2-wa2.dat")
  (lstm2-read-weight-from *ua2* "examples/gench-lstm2-weights/gench-lstm2-ua2.dat")
  (lstm2-read-weight-from *ba2* "examples/gench-lstm2-weights/gench-lstm2-ba2.dat")
  (lstm2-read-weight-from *wi2* "examples/gench-lstm2-weights/gench-lstm2-wi2.dat")
  (lstm2-read-weight-from *ui2* "examples/gench-lstm2-weights/gench-lstm2-ui2.dat")
  (lstm2-read-weight-from *bi2* "examples/gench-lstm2-weights/gench-lstm2-bi2.dat")
  (lstm2-read-weight-from *wf2* "examples/gench-lstm2-weights/gench-lstm2-wf2.dat")
  (lstm2-read-weight-from *uf2* "examples/gench-lstm2-weights/gench-lstm2-uf2.dat")
  (lstm2-read-weight-from *bf2* "examples/gench-lstm2-weights/gench-lstm2-bf2.dat")
  (lstm2-read-weight-from *wo2* "examples/gench-lstm2-weights/gench-lstm2-wo2.dat")
  (lstm2-read-weight-from *uo2* "examples/gench-lstm2-weights/gench-lstm2-uo2.dat")
  (lstm2-read-weight-from *bo2* "examples/gench-lstm2-weights/gench-lstm2-bo2.dat")

  (lstm2-read-weight-from *wy* "examples/gench-lstm2-weights/gench-lstm2-wy.dat")
  (lstm2-read-weight-from *by* "examples/gench-lstm2-weights/gench-lstm2-by.dat"))
