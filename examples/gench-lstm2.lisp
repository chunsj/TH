...
(defparameter *ba1* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))
...
(defparameter *bi1* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))
...
(defparameter *bf1* ($push *lstm2* (ones 1 *hidden-size*)))
...
(defparameter *bo1* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))
...
(defparameter *ba2* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))
...
(defparameter *bi2* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))
...
(defparameter *bf2* ($push *lstm2* (ones 1 *hidden-size*)))
...
(defparameter *bo2* ($push *lstm2* ($- ($* 0.16 (rnd 1 *hidden-size*)) 0.08)))

(defparameter *wy* ($push *lstm2* ($- ($* 0.16 (rnd *hidden-size* *vocab-size*)) 0.08)))
(defparameter *by* ($push *lstm2* ($- ($* 0.16 (rnd 1 *vocab-size*)) 0.08)))
