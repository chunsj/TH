...
(let* ((rgb (tensor-from-png-file "data/cat.vgg16.png"))
  ...
  (prn (-> x
           ...
           (blk :k14 :g14 :b14 :k15 :g15 :b15 :k16 :g16 :b16 2)
           (blk :k17 :g17 :b17 :k18 :g18 :b18 :k19 :g19 :b19 2)
           (blk :k20 :g20 :b20 :k21 :g21 :b21 :k22 :g22 :b22 2)
           (blkd :k23 :g23 :b23 :k24 :g24 :b24 :k25 :g25 :b25 :dk3 :dg3 :db3 2)
           (blk :k26 :g26 :b26 :k27 :g27 :b27 :k28 :g28 :b28 2)
           (blk :k29 :g29 :b29 :k30 :g30 :b30 :k31 :g31 :b31 2)
           (blk :k32 :g32 :b32 :k33 :g33 :b33 :k34 :g34 :b34 2)
           (blk :k35 :g35 :b35 :k36 :g36 :b36 :k37 :g37 :b37 2)
           (blk :k38 :g38 :b38 :k39 :g39 :b39 :k40 :g40 :b40 2)
           (blkd :k41 :g41 :b41 :k42 :g42 :b42 :k43 :g43 :b43 :dk4 :dg4 :db4 2)
           (blk :k44 :g44 :b44 :k45 :g45 :b45 :k46 :g46 :b46 2)
           (blk :k47 :g47 :b47 :k48 :g48 :b48 :k49 :g49 :b49 2)
           ;;($avgpool2d 7 7 1 1)
           )))
...
(defun blkd (x k1 g1 b1 k2 g2 b2 k3 g3 b3 dk dg db &optional (stride 1))
  (let* ((r (-> x
                ...
                ($bn (w dg) (w db))))
         (o (-> x
                ($conv2d (w k1) nil stride stride)
                ($bn (w g1) (w b1))
                ($relu)
                ($conv2d (w k2) nil stride stride 1 1)
                ($bn (w g2) (w b2))
                ($relu)
                ($conv2d (w k3) nil stride stride)
                ($bn (w g3) (w b3)))))
    ($relu ($+ o r))))

;; XXX find correct stride size and application point
(defun blk (x k1 g1 b1 k2 g2 b2 k3 g3 b3 &optional (stride 1))
  (let ((r x)
        (o (-> x
               ($conv2d (w k1) nil stride stride)
               ($bn (w g1) (w b1))
