...
(defun rnn-write-weights ()
  (write-weight-to *wx* "char-rnn-wx.dat")
  (write-weight-to *wh* "char-rnn-wh.dat")
  (write-weight-to *wy* "char-rnn-wy.dat")
  (write-weight-to *bh* "char-rnn-bh.dat")
  (write-weight-to *by* "char-rnn-by.dat"))

(defun rnn-read-weights ()
  (read-weight-from *wx* "char-rnn-wx.dat")
  (read-weight-from *wh* "char-rnn-wh.dat")
