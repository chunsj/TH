...
(defgeneric nn-elu-update-output (input output alpha in-place))
(defmethod nn-elu-update-output ((input tensor.float) output alpha in-place)
  (thnn-float-elu-update-output (defstate)
                                ($handle input)
                                ($handle output)
                                (coerce alpha 'double-float)
                                (if in-place 1 0)))
(defmethod nn-elu-update-output ((input tensor.double) output alpha in-place)
...
(defmethod nn-elu-update-grad-input ((input tensor.float) (grad-output tensor.float)
                                     grad-input output alpha in-place)
