...
(defgeneric nn-elu-update-grad-input (input grad-output grad-input output alpha scale))
(defmethod nn-elu-update-grad-input ((input tensor.float) (grad-output tensor.float)
                                     ...
                                     alpha scale)
  (thnn-float-elu-update-grad-input (defstate) ($handle input) ($handle grad-output)
...
(defmethod nn-elu-update-grad-input ((input tensor.double) (grad-output tensor.double)
                                     ...
                                     alpha scale)
  (thnn-double-elu-update-grad-input (defstate) ($handle input) ($handle grad-output)
                                     ($handle grad-input) ($handle output)
                                     (coerce alpha 'double-float)
                                     (coerce scale 'double-float)))
