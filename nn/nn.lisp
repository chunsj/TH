...
(defmethod nn-elu-update-output ((input tensor.float) (output tensor.float) alpha in-place)
  (thnn-float-elu-update-output (defstate)
                                ($handle input)
                                ($handle output)
                                (coerce alpha 'double-float)
                                (if in-place 1 0)))
(defmethod nn-elu-update-output ((input tensor.double) (output tensor.double) alpha in-place)
...
(defgeneric nn-celu-update-output (input output alpha in-place))
(defmethod nn-celu-update-output ((input tensor.float) (output tensor.float) alpha in-place)
  (thnn-float-celu-update-output (defstate)
                                 ($handle input)
                                 ($handle output)
                                 (coerce alpha 'double-float)
                                 (if in-place 1 0)))
(defmethod nn-celu-update-output ((input tensor.double) (output tensor.double) alpha in-place)
  (thnn-double-celu-update-output (defstate)
                                  ($handle input)
                                  ($handle output)
                                  (coerce alpha 'double-float)
                                  (if in-place 1 0)))
(defgeneric nn-celu-update-grad-input (input grad-output grad-input output alpha in-place))
(defmethod nn-celu-update-grad-input ((input tensor.float) (grad-output tensor.float)
                                      (grad-input tensor.float) (output tensor.float)
                                      alpha in-place)
  (thnn-float-celu-update-grad-input (defstate)
                                     ($handle input)
                                     ($handle grad-output)
                                     ($handle grad-input)
                                     ($handle output)
                                     (coerce alpha 'double-float)
                                     (if in-place 1 0)))
(defmethod nn-celu-update-grad-input ((input tensor.double) (grad-output tensor.double)
                                      (grad-input tensor.double) (output tensor.double)
                                      alpha in-place)
  (thnn-double-celu-update-grad-input (defstate)
                                      ($handle input)
                                      ($handle grad-output)
                                      ($handle grad-input)
                                      ($handle output)
...
(defgeneric nn-selu-update-output (input output alpha lmbda in-place))
(defmethod nn-selu-update-output ((input tensor.float) (output tensor.float) alpha lmbda in-place)
  (thnn-float-selu-update-output (defstate)
                                 ($handle input)
                                 ($handle output)
                                 (coerce alpha 'double-float)
                                 (coerce lmbda 'double-float)
                                 (if in-place 1 0)))
(defmethod nn-selu-update-output ((input tensor.double) (output tensor.double) alpha lmbda in-place)
  (thnn-double-selu-update-output (defstate)
                                  ($handle input)
                                  ($handle output)
                                  (coerce alpha 'double-float)
                                  (coerce lmbda 'double-float)
                                  (if in-place 1 0)))
(defgeneric nn-selu-update-grad-input (input grad-output grad-input output alpha lbmda in-place))
(defmethod nn-selu-update-grad-input ((input tensor.float) (grad-output tensor.float)
                                      (grad-input tensor.float) (output tensor.float)
                                      alpha lmbda in-place)
  (thnn-float-selu-update-grad-input (defstate)
                                     ($handle input)
                                     ($handle grad-output)
                                     ($handle grad-input)
                                     ($handle output)
                                     ...
                                     (coerce lmbda 'double-float)
                                     (if in-place 1 0)))
(defmethod nn-selu-update-grad-input ((input tensor.double) (grad-output tensor.double)
                                      (grad-input tensor.double) (output tensor.double)
                                      alpha lmbda in-place)
  (thnn-double-selu-update-grad-input (defstate)
                                      ($handle input)
                                      ($handle grad-output)
                                      ($handle grad-input)
                                      ($handle output)
