...
(defgeneric nn-col2im-update-output (input output oh ow kh kw dh dw ph pw sh sw))
(defmethod nn-col2im-update-output ((input tensor.float) (output tensor.float)
                                    oh ow kh kw dh dw ph pw sh sw)
  (thnn-float-col2im-update-output (defstate) ($handle input) ($handle output)
                                   oh ow kh kw dh dw ph pw sh sw))
(defmethod nn-col2im-update-output ((input tensor.double) (output tensor.double)
                                    oh ow kh kw dh dw ph pw sh sw)
  (thnn-double-col2im-update-output (defstate) ($handle input) ($handle output)
                                    oh ow kh kw dh dw ph pw sh sw))

(defgeneric nn-col2im-update-grad-input (grad-output grad-input kh kw dh dw ph pw sh sw))
(defmethod nn-col2im-update-grad-input ((grad-output tensor.float) (grad-input tensor.float)
                                        kh kw dh dw ph pw sh sw)
  (thnn-float-col2im-update-grad-input (defstate) ($handle grad-output) ($handle grad-input)
                                       kh kw dh dw ph pw sh sw))
(defmethod nn-col2im-update-grad-input ((grad-output tensor.double) (grad-input tensor.double)
                                        kh kw dh dw ph pw sh sw)
  (thnn-double-col2im-update-grad-input (defstate) ($handle grad-output) ($handle grad-input)
                                        kh kw dh dw ph pw sh sw))
...
(defgeneric nn-elu-update-output (input output alpha scale in-place))
(defmethod nn-elu-update-output ((input tensor.float) (output tensor.float)
                                 alpha scale in-place)
  (thnn-float-elu-update-output (defstate) ($handle input) ($handle output)
                                (coerce alpha 'double-float)
                                (coerce scale 'double-float)
                                (if in-place 1 0)))
(defmethod nn-elu-update-output ((input tensor.double) (output tensor.double)
                                 alpha scale in-place)
  (thnn-double-elu-update-output (defstate) ($handle input) ($handle output)
                                 (coerce alpha 'double-float)
                                 (coerce scale 'double-float)
                                 (if in-place 1 0)))

(defgeneric nn-elu-update-grad-input (grad-output grad-input output alpha scale))
(defmethod nn-elu-update-grad-input ((grad-output tensor.float)
                                     (grad-input tensor.float) (output tensor.float)
                                     alpha scale)
  (thnn-float-elu-update-grad-input (defstate) ($handle grad-output)
                                    ($handle grad-input) ($handle output)
                                    (coerce alpha 'double-float)
                                    (coerce scale 'double-float)))
(defmethod nn-elu-update-grad-input ((grad-output tensor.double)
                                     (grad-input tensor.double) (output tensor.double)
                                     alpha scale)
  (thnn-double-elu-update-grad-input (defstate) ($handle grad-output)
                                     ($handle grad-input) ($handle output)
                                     (coerce alpha 'double-float)
                                     (coerce scale 'double-float)))
...
(defgeneric nn-elu-update-output (input output alpha scale in-place))
(defmethod nn-elu-update-output ((input tensor.float) output alpha scale in-place)
  (thnn-float-elu-update-output (defstate)
                                ($handle input)
                                ($handle output)
                                (coerce alpha 'double-float)
                                (coerce scale 'double-float)
                                (if in-place 1 0)))
(defmethod nn-elu-update-output ((input tensor.double) output alpha scale in-place)
  (thnn-double-elu-update-output (defstate)
                                 ($handle input)
                                 ($handle output)
                                 (coerce alpha 'double-float)
                                 (coerce scale 'double-float)
...
(defgeneric nn-elu-update-grad-input (grad-output grad-input output alpha scale))
(defmethod nn-elu-update-grad-input ((grad-output tensor.float) grad-input output alpha scale)
  (thnn-float-elu-update-grad-input (defstate)
                                    ...
                                    (coerce alpha 'double-float)
                                    (coerce scale 'double-float)))
(defmethod nn-elu-update-grad-input ((grad-output tensor.double) grad-input output alpha scale)
...
(defgeneric nn-temporal-reflection-padding-update-output (input output pl pr))
(defmethod nn-temporal-reflection-padding-update-output ((input tensor.float)
                                                         (output tensor.float)
                                                         pl pr)
  (thnn-float-temporal-reflection-padding-update-output (defstate)
                                                        ($handle input)
                                                        ($handle output)
                                                        pl pr))
(defmethod nn-temporal-reflection-padding-update-output ((input tensor.double)
                                                         (output tensor.double)
                                                         pl pr)
  (thnn-double-temporal-reflection-padding-update-output (defstate)
                                                         ($handle input)
                                                         ($handle output)
                                                         pl pr))

(defgeneric nn-temporal-reflection-padding-update-grad-input (input grad-output grad-input pl pr))
(defmethod nn-temporal-reflection-padding-update-grad-input ((input tensor.float)
                                                             (grad-output tensor.float)
                                                             (grad-input tensor.float)
                                                             pl pr)
  (thnn-float-temporal-reflection-padding-update-grad-input (defstate)
                                                            ($handle input)
                                                            ($handle grad-output)
                                                            ($handle grad-input)
                                                            pl pr))
(defmethod nn-temporal-reflection-padding-update-grad-input ((input tensor.double)
                                                             (grad-output tensor.double)
                                                             (grad-input tensor.double)
                                                             pl pr)
  (thnn-double-temporal-reflection-padding-update-grad-input (defstate)
                                                             ($handle input)
                                                             ($handle grad-output)
                                                             ($handle grad-input)
                                                             pl pr))

(defgeneric nn-temporal-replication-padding-update-output (input output pl pr))
(defmethod nn-temporal-replication-padding-update-output ((input tensor.float)
                                                          (output tensor.float)
                                                          pl pr)
  (thnn-float-temporal-replication-padding-update-output (defstate)
                                                         ($handle input)
                                                         ($handle output)
                                                         pl pr))
(defmethod nn-temporal-replication-padding-update-output ((input tensor.double)
                                                          (output tensor.double)
                                                          pl pr)
  (thnn-double-temporal-replication-padding-update-output (defstate)
                                                          ($handle input)
                                                          ($handle output)
                                                          pl pr))

(defgeneric nn-temporal-replication-padding-update-grad-input (input grad-output grad-input pl pr))
(defmethod nn-temporal-replication-padding-update-grad-input ((input tensor.float)
                                                              (grad-output tensor.float)
                                                              (grad-input tensor.float)
                                                              pl pr)
  (thnn-float-temporal-replication-padding-update-grad-input (defstate)
                                                             ($handle input)
                                                             ($handle grad-output)
                                                             ($handle grad-input)
                                                             pl pr))
(defmethod nn-temporal-replication-padding-update-grad-input ((input tensor.double)
                                                              (grad-output tensor.double)
                                                              (grad-input tensor.double)
                                                              pl pr)
  (thnn-double-temporal-replication-padding-update-grad-input (defstate)
                                                              ($handle input)
                                                              ($handle grad-output)
                                                              ($handle grad-input)
                                                              pl pr))
