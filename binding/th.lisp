...
(defgeneric $binomial (object n p)
  (:documentation "Returns binomial random number."))
...
(defgeneric $geometric! (x p)
  (:documentation "Returns tensor x filled with geometric random numbers."))
(defgeneric $hypergeometric! (x nr nb k)
  (:documentation "Returns tensor x filled with hypergeometric random numbers."))
(defgeneric $binomial! (x n p)
  (:documentation "Returns tensor x filled with binomial random numbers."))
...
(defgeneric $chisq! (x df)
  (:documentation "Returns tensor x filled with chisq random numbers."))
