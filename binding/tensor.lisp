...
#+ccl (defmethod ccl:terminate ((x tensor.byte))
        (when (has-valid-handle-p x)
          (th-byte-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.char))
        (when (has-valid-handle-p x)
          (th-char-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.short))
        (when (has-valid-handle-p x)
          (th-short-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.int))
        (when (has-valid-handle-p x)
          (th-int-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.long))
        (when (has-valid-handle-p x)
          (th-long-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.float))
        (when (has-valid-handle-p x)
          (th-float-tensor-free ($handle h))
          (reset-handle x)))
#+ccl (defmethod ccl:terminate ((x tensor.double))
        (when (has-valid-handle-p x)
          (th-double-tensor-free ($handle h))
          (reset-handle x)))
